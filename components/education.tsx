...
const Education = () => {
  return (
    <div className="py-16 lg:px-14 px-8 md:flex items-start">
      ...
      <div className="flex-1 lg:pt-0 pt-10">
        <div className="flex pb-10 justify-between">
          <div>
            <h1 className="font-semibold text-lg">BTech in Artificial Intelligence</h1>
            <p>GHRCE</p>
          </div>
        ...
        <div className="flex justify-between">
          <div>
            <h1 className="font-semibold text-lg">Diploma in Computer Engineering</h1>
            <p>GHRIET</p>
          </div>
          <p className="hidden lg:block text-lg text-[#aaaaaa]">CRPF, Nagpur</p>
          <p className="">2022-2025</p>
        </div>
      </div>
    </div>
  );
