...
const Tools = () => {
  return (
    <div className="py-24 lg:px-14 px-8 md:flex items-start">
      <div className="flex flex-col flex-1 lg:pb-0 pb-8">
        <h2 className="text-xl font-semibold">Tools</h2>
        <div className="flex items-center gap-1">
          <p className="text-lg text-[#aaaaaa]">My Daily Tools</p>
        </div>
      </div>
      <div className="flex-1 lg:flex gap-10">
        <Link href="/tools/colorshadegenerator">
          <div className="flex lg:pb-0 pb-8 gap-4 items-center">
            <div className="w-12 h-12 flex items-center justify-center rounded-md bg-black">
              <svg
            ...
            <p className="text-lg">Color Shade Generator</p>
          </div>
        </Link>
        <Link href="/tools/qrgenerator">
          <div className="flex gap-4 lg:pb-0 pb-8 items-center">
            <div className="w-12 h-12 flex items-center justify-center rounded-md bg-black">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            <p className="text-lg">QR Generator</p>
          </div>
        </Link>
      </div>
    </div>
